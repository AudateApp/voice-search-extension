...
export type LocaleProperties = {
  name: string,
  bcp_47: string,
  model: 'Default'|'Command and search'|'Phone call'|'Enhanced phone call'|'Medical Dictation'|'Medical Conversation'|'Enhanced video',
...
const SupportedLocalesAndProperties: LocaleProperties[] = locales as LocaleProperties[];

export const LocalesForDefaultModel = SupportedLocalesAndProperties.filter(l => l.model === "Default");
export const DefaultLocale = LocalesForDefaultModel.filter(l => l.bcp_47 === "en-US")[0];
